...
class MGLAD(nn.Module):
    ...
    def build_layer(self):
        return MPNNLayer(wkr_dim=self.wkr_dim, num_nodes=self.num_nodes, num_wkr=self.num_wkr,num_tsk = self.num_tsk,tsk_dim=self.tsk_dim,
