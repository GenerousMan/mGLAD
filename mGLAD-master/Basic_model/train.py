...
flags.DEFINE_integer('ability_num', 200, 'Weight for L2 loss on embedding matrix.')
...
#shape,worker_num,task_num,edge_type,edges,true_labels = read_Websites()
shape,worker_num,task_num,edge_type,edges,true_labels = read_Flowers()
