...
def read_duck():
    ...
    return Graph2Edgelist(graph),280,2,40,true_labels
...
def read_Websites():
    ...
    return Graph2Edgelist(Graph),n_samples+source_num,5,source_num,true_labels
...
def read_Flowers():
    ...
    #print(Graph[7])
    print("[ data ] Building finished.")
    return Graph2Edgelist(Graph),source_num+n_samples,2,source_num,true_labels
